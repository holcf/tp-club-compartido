...
insert into cuota values(0,1,300, 20231022, 1, 20231025, 20231125);
 ...
 begin
     ...
     if existe is null then
		set rta = 0; /* no existe el socio, mal puesto el dni */
     	 ...
     	 insert into cuota values(0,inNSocio, inMonto, inFechaPago, inMetodoPago, inFechaInicio, inVencimiento);
		 set rta  = 1;
	 end if;		 
